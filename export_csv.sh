...
sqlite3 -header -csv ./data/data.db "select song_id, name, difficulty, unofficial_diff, ec_diff, hc_diff, exh_diff from ereternet_difficulty order by song_id" > ./data/ereternet_difficulty_diffonly.csv
